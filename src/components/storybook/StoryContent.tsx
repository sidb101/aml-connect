    ...
    return (
        <div className={"xlight-panel content-container StoryContent_container"}>
            ...
            <div className={"white-panel  StoryContent_projectPanel"}>
                ...
                <div className={"regular-text light-grey-text"}> An AnalogML model that detects the sound of dog bark for deployment in the outdoor context. It is trained on a near and far field dataset of dog barks of common American dog breeds. It employs 4 analog features and uses a 2-layer neural network. </div>
