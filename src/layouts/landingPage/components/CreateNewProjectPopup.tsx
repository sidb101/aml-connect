...
export const CreateNewProjectPopup = () => {
	return (
		<div className={`CreateNewProjectPopup_container`}>
			<div className={`section-subheading-text grey-text CreateNewProjectPopup_heading`}>FROM ASPINITY</div>
			...
			<div className={`section-subheading-text grey-text CreateNewProjectPopup_heading`}>OR</div>
			<button className={`btn CreateNewProjectPopup_button regular-text`}>Create from scratch</button>
		</div>
	);
};
