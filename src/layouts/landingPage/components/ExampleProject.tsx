...
interface ExampleProjectInterface {
    projectName: string;
}

export const ExampleProject: React.FC<ExampleProjectInterface> = (props) => {
    return (
        <div className={`StoryContent_container`}>
            <div className={`white-panel  StoryContent_projectPanel`}>
                ...
                <div className="regular-text light-grey-text">
                    An AnalogML model that detects the sound of dog bark
                    for deployment in the outdoor context. It is trained on a near and far field dataset of dog
                    barks of common American dog breeds. It employs 4 analog features and uses a 2-layer neural
                    network.
                </div>
                ...
                <br/>
                <button className="btn btn-outline">Open Project &nbsp;&nbsp;
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="arrow-right"
                         className="svg-inline--fa fa-arrow-right " role="img"
