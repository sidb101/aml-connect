			...
			<div className={`body-content-container-no-footer`}>
				<div className={`main-content-container`}>
					<div className={`LandingView_container`}>
						{projectCards.map((projectCards: ProjectCardT[], index: number) => (
							<div key={index} className={`LandingView_containerRow`}>
								<ProjectCard projectCard={projectCards[0]} />
								<ProjectCard projectCard={projectCards[1]} />
							</div>
						))}
					</div>
				</div>
