...
export const CHECK_SEPARATION_ROUTE = `${MODEL_CREATION_ROUTE}/check-separation`;
export const MAKE_YOUR_NEURAL_NET_ROUTE = `${MODEL_CREATION_ROUTE}/make-your-neural-net`;
export const TRAIN_YOUR_NEURAL_NET_ROUTE = `${MODEL_CREATION_ROUTE}/train-your-neural-net`;
...
export const checkSeparationRoute = (projectSlug: string) => CHECK_SEPARATION_ROUTE.replace(PROJECT_SLUG, projectSlug);
export const makeYourNeuralNetRoute = (projectSlug: string) =>
	MAKE_YOUR_NEURAL_NET_ROUTE.replace(PROJECT_SLUG, projectSlug);
export const trainYourNeuralNetRoute = (projectSlug: string) =>
	TRAIN_YOUR_NEURAL_NET_ROUTE.replace(PROJECT_SLUG, projectSlug);
