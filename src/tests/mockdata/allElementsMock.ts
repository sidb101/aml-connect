	...
	Filter: {
		...
		parameters: {
			...
			filter_type: {
				...
				range_type: "discrete" as RangeType,
				range: ["FilterType.bpf2", "FilterType.lpf2", "FilterType.hpf2", "FilterType.lpf1"],
				unit: null,
				ui_component: "dropdown" as UIComponentType,
			},
		},
	...
	GainOpamp: {
		...
		parameters: {
			gain_mode: {
				...
				range_type: "discrete" as RangeType,
				range: [
					"GainOpampMode.Noninverting1x",
					"GainOpampMode.Noninverting11x",
					"GainOpampMode.Inverting2x",
					"GainOpampMode.Inverting4x",
					"GainOpampMode.Inverting10x",
					"GainOpampMode.Inverting20x",
				],
				unit: null,
				ui_component: "dropdown" as UIComponentType,
			},
			opamp_implementation: {
				...
				range_type: "discrete" as RangeType,
				range: ["OpampType.StageZero", "OpampType.Pin"],
				unit: null,
				ui_component: "dropdown" as UIComponentType,
			},
			feedback_cap_count: {
